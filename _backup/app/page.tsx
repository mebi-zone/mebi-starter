      ...
      <section className="container pt-16 pb-10">
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div className="space-y-6">
            <span className="inline-block rounded-full border border-mustard/40 bg-offwhite px-3 py-1 text-sm text-earth">Giải pháp SaaS cho CLB & Đơn vị tổ chức giải đấu Billiards</span>
            <h1 className="font-extrabold text-olive leading-snug">
              <span className="block text-3xl md:text-4xl">Ứng dụng</span>
              <span className="block text-5xl md:text-5xl">Quản lý giải đấu </span>
              <span className="block text-5xl md:text-5xl">& Phân hạng bida</span>
            </h1>
            ...
            <p className="mt-3 text-xl text-charcoal/80 text-amberx">
            ...
            <ul className="text-lg text-charcoal/80 space-y-2 list-disc list-inside">
              ...
              <li>Thống kê theo người chơi & giải đấu</li>
            </ul>
      ...
      <section className="container py-10">
        <div className="grid md:grid-cols-3 gap-6">
          {[
            ...
            { title: 'Kết quả & Thống kê', desc: 'Cập nhật real-time, bảng xếp hạng theo giải & người chơi, số liệu minh bạch.' },
          ].map((f, i) => (
