        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div className="space-y-6">
            ...
            <h1 className="font-extrabold leading-snug">
              <span className="block text-4xl md:text-5xl text-mustard">Nền tảng Quản lý </span>
              <span className="block text-4xl md:text-5xl text-olive">Giải đấu & Phân hạng</span>
              <span className="block text-4xl md:text-5xl text-olive">Bida chuyên nghiệp </span>
            </h1>
