        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div className="space-y-6">
            ...
            <h1 className="font-extrabold leading-snug">
              <span className="block text-6xl md:text-6xl text-mustard"> MEBI </span>
              <span className="block text-4xl md:text-4xl text-olive">Nền tảng ứng dụng quản lý giải đấu & phân hạng Billiards</span>
            </h1>
